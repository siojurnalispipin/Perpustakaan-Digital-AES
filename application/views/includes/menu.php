...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="<?php echo base_url('dashboard'); ?>"><strong>PERPUSTAKAAN DIGITAL</strong></a>
    </div>
    <!-- /.navbar-header -->
        ...
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="<?php echo base_url('peminjaman'); ?>"><i class="fa fa-share-square fa-fw"></i>
                                Peminjaman</a>
                        </li>
                        <li>
                            <a href="<?php echo base_url('pengembalian'); ?>"><i class="fa fa-check-square fa-fw"></i>
                                Pengembalian</a>
                        </li>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li>
                            <a href="<?php echo base_url('laporan/peminjaman'); ?>"><i class="fa fa-share-square fa-fw"></i>
                                Data Peminjaman</a>
                        </li>
                        <li>
                            <a href="<?php echo base_url('laporan/pengembalian'); ?>"><i class="fa fa-check-square fa-fw"></i>
                                Data Pengembalian</a>
                        </li>
                ...
                <!-- Modul Enkripsi - Dekripsi AES -->
                <li>
                    <a href="#"><i class="fa fa-desktop fa-fw"></i> Module AES - 128<span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="#"><i class="fa fa-desktop fa-fw"></i> Menu Enkripsi<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo base_url('enkripsi/file'); ?>"><i class="fa fa-file fa-fw"></i> Enkripsi File</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url('enkripsi/text'); ?>"><i class="fa fa-file-text fa-fw"></i> Enkripsi Text</a>
                                </li>    
                            </ul>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="<?php echo base_url('myfiles'); ?>"><i class="fa fa-book fa-fw"></i> File Terenkripsi</a>
                        </li>
