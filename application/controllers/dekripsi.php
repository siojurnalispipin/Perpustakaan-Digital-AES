...
class Dekripsi extends MY_Controller
{
    ...
    {
        $this->template->load('layoutbackend', 'dekripsi/dekrip_file');
    }
    ...
    public function file()
    {
        ...
        $this->template->load('layoutbackend', 'dekripsi/dekrip_file', $data);
    ...
    public function text(){
        ...
        $this->template->load('layoutbackend', 'dekripsi/dekrip_text', $data);
	}
}